...
class AnalyticGraphCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    this.addEditorTab('Axes', 'public/app/plugins/panel/analytic-graph/tab_axes.html', 2);
    this.addEditorTab('Legend', 'public/app/plugins/panel/analytic-graph/tab_legend.html', 3);
    this.addEditorTab('Display', 'public/app/plugins/panel/analytic-graph/tab_display.html', 4);
